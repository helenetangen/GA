...
public class Population{
    ...
    private volatile List<Individual> population;
     
     
    public Population(){
        this.population = Collections.synchronizedList(new ArrayList<Individual>());
    }
...
/*          System.out.print("Genotype: ");
    ...
    public void evaluateParallell(WindFarmLayoutEvaluator evaluator, ArrayList<double[]> grid, WindScenario scenario){
        int start = 0;
        int end   = 0;
        ...
        for (int i = 0; i < cores; i++) {
            ...
            threads[i] = new Thread(new Evaluator(start, end, grid, this, scenario));
        }
        for (int i = 0; i < cores; i++){
            threads[i].start();
        }
