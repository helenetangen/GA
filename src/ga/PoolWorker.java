...
public class PoolWorker implements Runnable{
	...
	public PoolWorker(int start, int end, Population childPopulation, Crossover crossover, WindFarmLayoutEvaluator evaluator, ArrayList<double[]> grid, Mutation mutation, int generations){
		this.start = start;
		this.end   = end;
